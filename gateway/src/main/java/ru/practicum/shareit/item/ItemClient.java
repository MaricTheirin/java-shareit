...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAvailableItemsBySearchQuery(String text, long userId, long from, long size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
        );
        return get("/search?text={text}&from={from}&size={size}" + text, userId, parameters);
    }
